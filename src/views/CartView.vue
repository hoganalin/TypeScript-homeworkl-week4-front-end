...
//CartInfo['carts'] → 取得 carts 屬性的類型
// 結果：Array<{ id: string, product_id: string, ... }>
// CartInfo['carts'][number] → 從陣列中取得單個元素的類型
// 結果：{ id: string, product_id: string, qty: number, name: string, price: number }
